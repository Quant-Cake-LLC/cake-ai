...
class VoidSettingsInput extends EditorInput {
	...
	override getName(): string {
		return nls.localize('voidSettingsInputsName', 'CakeAI Settings');
	}
...
Registry.as<IEditorPaneRegistry>(EditorExtensions.EditorPane).registerEditorPane(
	EditorPaneDescriptor.create(VoidSettingsPane, VoidSettingsPane.ID, nls.localize('VoidSettingsPane', "CakeAI Settings Pane")),
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			title: nls.localize2('voidSettings', "CakeAI: Toggle Settings"),
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			title: nls.localize2('voidSettings', "CakeAI: Open Settings"),
			f1: true,
			icon: Codicon.settingsGear,
		});
	}
...
MenuRegistry.appendMenuItem(MenuId.GlobalActivity, {
	...
	command: {
		id: VOID_TOGGLE_SETTINGS_ACTION_ID,
		title: nls.localize('voidSettings', "CakeAI Settings")
	},
	order: 1
});
