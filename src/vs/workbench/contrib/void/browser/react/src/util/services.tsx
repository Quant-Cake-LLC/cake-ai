...
export const _registerServices = (accessor: ServicesAccessor) => {
	...
	if (wasCalled) {
		return
		// console.error(`⚠️ CakeAI _registerServices was called again! It should only be called once.`)
	}
	wasCalled = true
...
export const useAccessor = () => {
	if (!reactAccessor_) {
		throw new Error(`⚠️ CakeAI useAccessor was called before _registerServices!`)
	}
