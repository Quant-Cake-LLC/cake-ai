...
// const voidViewIcon = registerIcon('void-view-icon', voidThemeIcon, localize('voidViewIcon', 'View icon of the Cake AI Terminal view.'));
...
const container = viewContainerRegistry.registerViewContainer({
	...
	title: nls.localize2('voidContainer', 'Cake AI Terminal'), // this is used to say "CakeAI" (Ctrl + L)
