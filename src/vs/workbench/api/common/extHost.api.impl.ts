...
export function createApiFactoryAndRegisterActors(accessor: ServicesAccessor): IExtensionApiFactory {
	...
	return function (extension: IExtensionDescription, extensionInfo: IExtensionRegistries, configProvider: ExtHostConfigProvider): typeof vscode {
		...
		const languages: typeof vscode.languages = {
			...
			// CakeAI added addInlineDiff here:
			...
			// CakeAI added this (I think will need to add this back when add ctrl+K)
		...
		const window: typeof vscode.window = {
			...
			createWebviewTextEditorInset(editor: vscode.TextEditor, line: number, height: number, options?: vscode.WebviewOptions): vscode.WebviewEditorInset {
				// checkProposedApiEnabled(extension, 'editorInsets'); // CakeAI commented this out
