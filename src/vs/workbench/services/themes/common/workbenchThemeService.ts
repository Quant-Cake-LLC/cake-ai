...
export enum ThemeSettingDefaults {
	COLOR_THEME_DARK = 'Cake AI',
	COLOR_THEME_LIGHT = 'Cake AI',
	COLOR_THEME_HC_DARK = 'Cake AI',
	COLOR_THEME_HC_LIGHT = 'Cake AI',

	COLOR_THEME_DARK_OLD = 'Cake AI',
	COLOR_THEME_LIGHT_OLD = 'Cake AI',
...
export const COLOR_THEME_DARK_INITIAL_COLORS = { // CakeAI changed this to match dark+
