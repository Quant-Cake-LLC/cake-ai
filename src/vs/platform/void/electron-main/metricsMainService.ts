...
export class MetricsMainService extends Disposable implements IMetricsService {
	...
	// helper - looks like this is stored in a .vscdb file in ~/Library/Application Support/CakeAI
	...
	async initialize() {
		...
		console.log('CakeAI posthog metrics info:', JSON.stringify(identifyMessage, null, 2))
	}
